...
# See https://github.com/aristofanio/tinodechat/rest-auth for details.
...
def index():
    return 'Sample Tinode REST/JSON-RPC authentication service. '+\
        'See <a href="https://github.com/aristofanio/tinodechat/rest-auth/">https://github.com/aristofanio/tinodechat/rest-auth/</a> for details.'
